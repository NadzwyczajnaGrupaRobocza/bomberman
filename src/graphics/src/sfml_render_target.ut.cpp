...
{
public:
    render_target<render_target_stub> renderTarget{window_size{200, 300}, 100};
};
...
TEST(RenderTargetOverridedFuncionsTest, setAndGetSize)
{
    ...
    sfml_render_target renderTarget200x300{size_200x300, 100};
    sfml_render_target renderTarget400x300{size_400x300, 100};
     ...
     setActive_dummyMethodShouldJustReturnTrue)
{
    ...
    sfml_render_target renderTarget{dummy_size, 100};
